    ...
    return (
        <section className='my-10 space-y-5'>
            <div id='title' className='text-center'>
                <h1 className='text-5xl font-extrabold'>Life Style</h1>
            ...
            <div className='space-y-5'>
                <div  className='flex justify-center  gap-14'>
                    ...
                    <p className=' top-1/2 text-4xl font-extrabold left-1/4 text-white'>History Places</p>
                    </div>
                    <img src='https://i.ibb.co/vQsY3tG/relaxtravel.jpg' className='w-[500px] rounded-lg'></img>
                </div>
                <div>
                <div className='flex justify-center  gap-10'>
                    <img src='https://i.ibb.co/jvnPgW3/City.jpg' className='w-[500px] my-auto h-fit rounded-lg'></img>
